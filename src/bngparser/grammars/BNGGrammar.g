...
: 
  READFILE LPAREN LBRACKET 
    ((ATOMIZE ASSIGNS INT | BLOCKS ASSIGNS bng_blocks_list | SKIPACTIONS ASSIGNS INT) COMMA)* 
    FILE ASSIGNS DBQUOTES filename DBQUOTES
    (COMMA (ATOMIZE ASSIGNS INT | BLOCKS ASSIGNS bng_blocks_list | SKIPACTIONS ASSIGNS INT))*
